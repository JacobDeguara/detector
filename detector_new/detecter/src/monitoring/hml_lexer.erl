%% Jacob's Note: You need to make or an accepted token named or_op like and_op... gl  
...
%% Generated action function.
    ...
    case yystate(yystate(), Ics0, L0, 0, reject, 0) of
        ...
        {A,Alen,Tlen,_Ics1,L1,_S1} ->
            Tcs1 = yysuf(Tcs, Alen), % does nthtail()
            L2 = adjust_line(Tlen, Alen, Tcs1, L1), % fixes Line to be ajcusted correctly
            string_cont(Tcs1, L2, yyaction(A, Alen, Tcs, L0), Ts)
    end.
% 1,2,4 results are identical. while 4 being slighlty different to account for the difference in the way it works
% 3 is for errors
...
%%% yystate(yystate(), Ics0, L0, 0, reject, 0)
%% yystate(State, InChars, Line, CurrTokLen, AcceptAction, AcceptLen) ->
%% {Action, AcceptLen, RestChars, Line} |
%% {Action, AcceptLen, RestChars, Line, State} |
%% {reject, AcceptLen, CurrTokLen, RestChars, Line, State} |
