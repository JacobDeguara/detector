                ...
                {rec,
                 ...
                 {nec,
                  ...
                  {'and',
                   ...
                   {'or',
                    ignore,
                    {nec, ignore, "{trace,'_',send,'_',{[ok|alloc],[]}}", {no, ignore}},
                    {nec, ignore, "{trace,'_',send,'_',{[ok|close],[]}}", {no, ignore}}}}}}}}],
                 ...
                 fun X(Trace3) ->
                         fun (_E = {trace, _, 'receive', {_, {rec, _}}}) ->
                                 ...
                                 fun (_E = {trace, _, send, {ok, msg}, _}) ->
                                     ...
                                     (_E = {trace, _, send, {ok, close}, _}) ->
                                         Trace5 =
                                             lists:append(Trace4,
                                                          ["{trace,'_',send,'_',{[ok|close],[]}}"]),
                                         io:format("\e[37m*** [~w] Analyzing event ~p.~n\e[0m",
                                                   [self(), _E]),
                                         begin
                                             History = proof_eval:write_history(Trace5, FileName),
